...
export default function TechBadge({ name, logo, description }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Glow effect */}
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-accent to-accentSecondary opacity-0 blur-xl transition-opacity group-hover:opacity-20 motion-reduce:opacity-0" aria-hidden="true" />
