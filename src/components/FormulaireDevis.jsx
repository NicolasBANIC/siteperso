...
export default function FormulaireDevis() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      {/* Success Message */}
      {status === 'success' && (
        <div className="p-4 bg-[var(--color-primary-600)]/12 border border-[var(--color-primary-600)]/20 rounded-lg flex items-start gap-3">
          <CheckCircle className="w-5 h-5 text-[var(--color-primary-500)] flex-shrink-0 mt-0.5" />
          <div>
            <p className="font-semibold text-[var(--color-primary-300)]">
