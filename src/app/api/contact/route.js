    ...
    const emailHtml = `
      ...
      <head>
        ...
        <style>
          ...
          .header { background: linear-gradient(135deg, #00C49A 0%, #0084C8 100%); color: white; padding: 30px; border-radius: 12px 12px 0 0; }
          .content { background: #f8f9fa; padding: 30px; border-radius: 0 0 12px 12px; }
          .info-box { background: white; padding: 20px; border-radius: 8px; margin: 15px 0; border-left: 4px solid #00C49A; }
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="info-box">
              ...
              <div class="value"><a href="mailto:${email}" style="color: #0084C8; text-decoration: none;">${email}</a></div>
            </div>
