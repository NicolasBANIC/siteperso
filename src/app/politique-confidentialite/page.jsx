export const metadata = {
  ...
  description:
    'Politique de confidentialité et protection des données personnelles du site BANDEV.',
};
        ...
        <div className="prose prose-lg max-w-none space-y-8 text-[var(--color-muted)]">
          ...
          <section>
            <p>
              ...
              <strong>BANDEV - Nicolas BANIC</strong>.
            </p>
            <p>
              Cette politique de confidentialité vous informe sur la manière dont nous collectons,
              utilisons, stockons et protégeons vos données personnelles conformément au Règlement
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Nom :</strong> Nicolas BANIC
              </li>
              <li>
                <strong>SIRET :</strong> 841 375 652 00028
              </li>
              <li>
                <strong>Email :</strong>{' '}
                <a
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Budget estimé</strong> (optionnel)
              </li>
              <li>
                <strong>Adresse IP</strong> (pour la sécurité et la prévention du spam)
              </li>
              <li>
                <strong>Date et heure de soumission</strong>
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Cookies techniques</strong> (préférences de thème clair/sombre)
              </li>
              <li>
                <strong>Données de navigation anonymes</strong> (si analytics activé)
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Répondre à vos demandes de contact</strong> et vous fournir les informations
                demandées
              </li>
              <li>
                <strong>Établir des devis</strong> et propositions commerciales
              </li>
              <li>
                <strong>Améliorer nos services</strong> et l'expérience utilisateur
              </li>
              <li>
                <strong>Prévenir le spam et les abus</strong> (via rate limiting et honeypot)
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Votre consentement</strong> (formulaire de contact, newsletter)
              </li>
              <li>
                <strong>L'exécution d'un contrat</strong> ou de mesures précontractuelles (devis,
                prestations)
              </li>
              <li>
                <strong>Notre intérêt légitime</strong> (amélioration des services, sécurité du
                site)
              </li>
              <li>
                <strong>Le respect d'obligations légales</strong> (comptabilité, fiscalité)
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Nicolas BANIC</strong> (responsable du traitement)
              </li>
              <li>
                <strong>Prestataires techniques</strong> (hébergement : Vercel, email : selon
                configuration SMTP)
              </li>
            </ul>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Chiffrement HTTPS</strong> (SSL/TLS) pour toutes les communications
              </li>
              <li>
                <strong>Rate limiting</strong> (limitation du nombre de requêtes par IP)
              </li>
              <li>
                <strong>Honeypot anti-spam</strong> sur le formulaire de contact
              </li>
              <li>
                <strong>Validation stricte</strong> des données côté client et serveur
              </li>
              <li>
                <strong>Hébergement sécurisé</strong> chez Vercel (certifié SOC 2)
              </li>
            </ul>
          </section>
          ...
          {/* Vos droits */}
          <section>
            <h2 className="text-2xl font-semibold text-[var(--color-foreground)]">8. Vos droits</h2>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Cookie de préférence de thème :</strong> Mémorise votre choix entre mode
                clair et sombre
              </li>
            </ul>
            <p>
              Ces cookies ne nécessitent pas de consentement préalable car ils sont essentiels au
              fonctionnement du site.
            </p>
            <p>
              Aucun cookie de tracking, publicitaire ou analytique n'est utilisé sans votre
          ...
          <section>
            ...
            <p>
              Nos prestataires techniques (Vercel) peuvent être situés en dehors de l'Union
              Européenne.
            </p>
            <p>
              Dans ce cas, nous nous assurons que des garanties appropriées sont mises en place
              (clauses contractuelles types de la Commission Européenne, certifications Privacy
              Shield, etc.).
            </p>
          </section>
          ...
          {/* Contact */}
          <section>
            <h2 className="text-2xl font-semibold text-[var(--color-foreground)]">12. Contact</h2>
            <p>
