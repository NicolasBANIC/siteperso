...
export default function LogoDemoPage() {
  return (
    <div className="min-h-screen bg-[var(--color-background)]">
      {/* Hero Section */}
      <section className="section-full bg-gradient-to-br from-[#0B3D0B] via-[#145214] to-[#082808]">
        <div className="container-page text-center">
          ...
          <div className="bg-[#111827] rounded-3xl p-16 mb-8 border border-[#00FF55]/20">
          ...
          {/* Logo sur fond clair */}
          <div className="bg-white rounded-3xl p-16 border border-[#00FF55]/20">
      ...
      <section className="section">
        <div className="container-page">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {/* Couleurs */}
            <div className="card">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#0B3D0B] to-[#145214] mb-4"></div>
              <h3 className="text-xl font-semibold mb-3">Vert Matrix Foncé</h3>
              <p className="text-[var(--color-muted)] mb-4">
                Lettres principales en vert profond (#0B3D0B → #145214)
              </p>
              <div className="flex gap-2">
                <div className="w-8 h-8 rounded bg-[#0B3D0B] border border-[var(--color-border)]"></div>
                <div className="w-8 h-8 rounded bg-[#145214] border border-[var(--color-border)]"></div>
                <div className="w-8 h-8 rounded bg-[#0A2F0A] border border-[var(--color-border)]"></div>
              </div>
            </div>

            {/* Lignes de code */}
            <div className="card">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#00FF55] to-[#33FF77] mb-4"></div>
              <h3 className="text-xl font-semibold mb-3">Vert Matrix Clair</h3>
              <p className="text-[var(--color-muted)] mb-4">
                Lignes de code lumineuses (#00FF55 → #33FF77)
              </p>
              <div className="flex gap-2">
                <div className="w-8 h-8 rounded bg-[#00FF55] border border-[var(--color-border)]"></div>
                <div className="w-8 h-8 rounded bg-[#33FF77] border border-[var(--color-border)]"></div>
                <div className="w-8 h-8 rounded bg-[#00FF55] border border-[var(--color-border)]"></div>
              </div>
            </div>
            ...
            {/* Animations */}
            <div className="card">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#00FF55] to-[#0B3D0B] mb-4 animate-pulse"></div>
            ...
            {/* Effet Matrix */}
            <div className="card">
              <div className="w-12 h-12 rounded-full bg-[#0B3D0B] mb-4 flex items-center justify-center text-[#00FF55] font-mono text-xs">
                &lt;/&gt;
              </div>
            ...
            {/* Lueur */}
            <div className="card">
              <div className="w-12 h-12 rounded-full bg-[#145214] mb-4 shadow-lg shadow-[#00FF55]/50"></div>
            ...
            {/* Responsive */}
            <div className="card">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#0B3D0B] to-[#00FF55] mb-4"></div>
      ...
      <section className="section">
        <div className="container-page">
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            {/* HTML */}
            <div className="card">
              <h3 className="text-lg font-semibold mb-4 text-[#00FF55]">HTML / JSX</h3>
...
.brand img {
  ...
  max-height: 100%;
            ...
            {/* Couleurs */}
            <div className="card">
              <h3 className="text-lg font-semibold mb-4 text-[#00FF55]">Palette de Couleurs</h3>
              <pre className="bg-[#111827] text-[#00FF55] p-6 rounded-xl overflow-x-auto text-sm font-mono">
...
#33FF77  /* Clair */`}
      ...
      {/* CTA */}
      <section className="section bg-gradient-to-br from-[#0B3D0B] via-[#145214] to-[#082808]">
        <div className="container-page text-center">
