      ...
      <div className="mx-auto max-w-4xl px-6">
        ...
        <div className="prose prose-lg max-w-none space-y-8 text-[var(--color-muted)]">
          ...
          <section>
            ...
            <p>
              L'ensemble du contenu du Site (textes, images, vidéos, logos, icônes, etc.) est la
              propriété exclusive de Nicolas BANIC, sauf mention contraire.
            </p>
            <p>
              Toute reproduction, distribution, modification, adaptation, retransmission ou
              publication de ces différents éléments est strictement interdite sans l'accord écrit
              de Nicolas BANIC.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              Les informations collectées via le formulaire de contact sont destinées uniquement à
              Nicolas BANIC pour répondre à vos demandes.
            </p>
            <p>
          ...
          {/* Cookies */}
          <section>
            <h2 className="text-2xl font-semibold text-[var(--color-foreground)]">6. Cookies</h2>
            <p>
              Le Site utilise des cookies techniques nécessaires à son bon fonctionnement
              (préférences de thème, etc.).
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              Nicolas BANIC s'efforce d'assurer l'exactitude et la mise à jour des informations
              diffusées sur le Site, mais ne peut garantir l'exactitude, la précision ou
              l'exhaustivité des informations mises à disposition.
            </p>
            <p>
              En conséquence, Nicolas BANIC décline toute responsabilité pour toute imprécision,
              inexactitude ou omission portant sur des informations disponibles sur le Site.
            </p>
            <p>
              Nicolas BANIC ne pourra être tenu responsable des dommages directs ou indirects
          ...
          <section>
            ...
            <p>
              Le Site peut contenir des liens hypertextes vers d'autres sites. Nicolas BANIC
              n'exerce aucun contrôle sur ces sites et décline toute responsabilité quant à leur
              contenu.
            </p>
            <p>
              La création de liens hypertextes vers le Site est autorisée sous réserve d'en informer
              préalablement Nicolas BANIC et de ne pas porter atteinte à l'image du Site.
            </p>
          </section>
          ...
          {/* Contact */}
          <section>
            <h2 className="text-2xl font-semibold text-[var(--color-foreground)]">10. Contact</h2>
            <p>
