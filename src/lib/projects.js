...
export const projects = [
  {
    ...
    context: 'Une marque de mode française souhaitait moderniser sa boutique en ligne pour améliorer les conversions et offrir une expérience utilisateur premium sur tous les devices.',
    ...
    technologies: ['Next.js 15', 'React 19', 'TypeScript', 'Stripe API', 'PostgreSQL', 'Tailwind CSS', 'Vercel'],
  ...
  },
  {
    ...
    summary: 'Application web métier avec visualisation de données en temps réel et exports automatisés',
    cover: '/images/portfolio/saas-dashboard.jpg',
    og: '/og/portfolio-saas-dashboard.png',
    stack: ['React', 'Node.js', 'PostgreSQL', 'Docker'],
    context: 'Une startup SaaS avait besoin d\'un dashboard analytics performant pour permettre à leurs clients de visualiser leurs métriques business en temps réel avec des exports automatisés.',
  ...
  },
  {
    ...
    context: 'Une architecte d\'intérieur cherchait un site vitrine moderne pour présenter ses réalisations avec une galerie photo haute qualité et des animations sobres.',
