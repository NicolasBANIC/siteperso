...
export const projects: Project[] = [
  ...
  // ========================================
  {
    ...
    target:
      'Particuliers et professionnels en Alsace et régions limitrophes recherchant des services de rénovation complète ou de remise en état après sinistre.',
    deliverables: [
    ...
    process: [
      {
        ...
        description:
          "Audit de la concurrence locale, définition des personas cibles (particuliers post-sinistre, propriétaires en rénovation), analyse des mots-clés SEO prioritaires et structuration de l'arborescence du site.",
      },
      {
        title: 'Design & Maquettage',
        description:
          'Création de wireframes et maquettes Figma avec focus sur la conversion (CTA visibles, formulaires simplifiés). Design professionnel avec palette de couleurs inspirée du bâtiment (bleus, gris, touches de jaune pour la confiance).',
      },
      {
        title: 'Développement',
        description:
          'Développement avec Next.js 14 (App Router) pour des performances optimales. Intégration de composants interactifs (calculateur de devis, slider avant/après). Mise en place de formulaires avec validation et envoi par email.',
      },
      {
        title: 'Contenu & SEO',
        description:
          'Rédaction de contenus optimisés SEO pour chaque service. Intégration de balises meta, données structurées (Schema.org) pour le référencement local. Optimisation des images et temps de chargement.',
      },
      {
        title: 'Tests & Déploiement',
        description:
          'Tests multi-navigateurs et multi-devices. Validation W3C, tests de performance (Lighthouse > 90). Déploiement sur Vercel avec configuration DNS et certificat SSL. Formation du client à la gestion du contenu.',
      },
    ],
    technologies: [
      'Next.js 14',
  ...
  // ========================================
  {
    ...
    shortDescription:
      'Site vitrine premium pour une agence de design UI/UX spécialisée dans les interfaces futuristes et les design systems.',
    description:
      "Création d'un site vitrine haut de gamme pour NOVA DESIGN, agence fictive spécialisée dans la conception d'interfaces utilisateur modernes et de design systems. Le site reflète l'identité premium de l'agence avec un design minimaliste, des animations subtiles et une navigation fluide.",
    context:
      "NOVA DESIGN est une agence de design d'interface positionnée sur le segment premium. Elle accompagne des startups tech et des scale-ups dans la création d'interfaces innovantes et de design systems cohérents. L'agence avait besoin d'un site vitrine à la hauteur de son expertise, capable de séduire des clients exigeants.",
    objectives: [
    ...
    target:
      'Startups tech, scale-ups et entreprises innovantes recherchant des services de design UI/UX premium pour leurs produits digitaux.',
    deliverables: [
    ...
    process: [
      {
        ...
        description:
          "Analyse de la concurrence premium (Ueno, Fantasy, Metalab). Définition de l'identité visuelle : minimalisme, futurisme, élégance. Création d'un moodboard avec références (Apple, Linear, Stripe).",
      },
      {
        title: 'Design System',
        description:
          "Création d'un design system complet : palette bleu nuit/blanc/argenté, typographie (Inter + Space Grotesk), composants UI réutilisables, grille 12 colonnes, espacements cohérents.",
      },
      {
        title: 'Maquettage Figma',
        description:
          'Conception de maquettes haute-fidélité pour toutes les pages. Prototypage des interactions clés. Création de variantes desktop/tablet/mobile. Validation avec animations et transitions.',
      },
      {
        title: 'Développement Front-end',
        description:
          'Développement Next.js avec TailwindCSS et Framer Motion. Intégration des animations (parallax, fade-in, hover effects). Optimisation des performances et du SEO. Tests multi-devices.',
      },
      {
        title: 'Contenu & Lancement',
        description:
          "Rédaction de contenus premium (ton expert et accessible). Shooting photo de l'équipe. Optimisation SEO et balises meta. Déploiement sur Vercel avec monitoring.",
      },
    ],
    technologies: [
      'Next.js 14',
  ...
  // ========================================
  {
    ...
    shortDescription:
      'Plateforme e-commerce éco-responsable connectant artisans locaux et consommateurs engagés pour des produits durables.',
    description:
      "Développement d'une marketplace complète pour ECHO MARKET, plateforme fictive dédiée aux produits éco-responsables. Le site permet aux artisans et producteurs locaux de vendre leurs créations durables tout en offrant aux consommateurs une expérience d'achat fluide et transparente.",
    context:
      "ECHO MARKET est une marketplace engagée qui souhaite démocratiser l'accès aux produits durables et artisanaux. La plateforme met en relation des artisans locaux (menuisiers, céramistes, maroquiniers, etc.) avec des consommateurs soucieux de l'environnement et de la qualité.",
    objectives: [
    ...
    target:
      'Consommateurs engagés (25-45 ans) recherchant des produits artisanaux et durables, et artisans locaux souhaitant vendre en ligne sans créer leur propre site.',
    deliverables: [
    ...
    process: [
      {
        ...
        description:
          "Analyse des marketplaces existantes (Etsy, La Ruche qui dit Oui, Ulule). Interviews d'artisans et de consommateurs engagés. Définition des fonctionnalités prioritaires (MVP).",
      },
      {
        title: 'Architecture & Design',
        description:
          "Conception de l'architecture technique (Next.js + MongoDB + Stripe). Design chaleureux et naturel (palette vert mousse, beige, bois clair). Wireframes et maquettes Figma pour toutes les pages.",
      },
      {
        title: 'Développement Back-end',
        description:
          "Mise en place de l'API avec gestion des utilisateurs (acheteurs/vendeurs), produits, commandes et paiements. Intégration Stripe Connect pour les paiements multi-vendeurs. Système d'upload d'images optimisé.",
      },
      {
        title: 'Développement Front-end',
        description:
          'Développement des interfaces utilisateur (catalogue, fiches produits, panier, checkout). Création du dashboard vendeur avec gestion des produits et statistiques. Intégration des animations et transitions.',
      },
      {
        title: 'Tests & Lancement',
        description:
          'Tests utilisateurs avec artisans et acheteurs. Optimisation des performances et du SEO. Mise en place du monitoring et des analytics. Déploiement progressif avec phase bêta.',
      },
    ],
    technologies: [
      'Next.js 14',
  ...
  // ========================================
  {
    ...
    shortDescription:
      "Plateforme de blog immersive dédiée à l'astronomie et aux sciences spatiales avec système de publication communautaire.",
    description:
      "Création d'une plateforme de blog communautaire pour ASTROBLOG, site fictif dédié à l'astronomie, l'astrophysique et l'exploration spatiale. Le site permet aux passionnés de publier des articles, de partager des découvertes et d'échanger avec une communauté engagée.",
    context:
      "ASTROBLOG est une plateforme communautaire qui souhaite démocratiser l'accès aux connaissances en astronomie et sciences spatiales. Le site s'adresse aux passionnés, étudiants et curieux désireux d'apprendre et de partager leur passion pour l'univers.",
    objectives: [
    ...
    target:
      "Passionnés d'astronomie, étudiants en sciences, curieux de l'espace et de l'univers (15-45 ans), cherchant des contenus vulgarisés et de qualité.",
    deliverables: [
    ...
    process: [
      {
        ...
        description:
          'Définition de la ligne éditoriale (vulgarisation scientifique, actualités spatiales, dossiers thématiques). Création de catégories (Système solaire, Étoiles, Galaxies, Missions spatiales, Astrophysique). Charte éditoriale et ton de communication.',
      },
      {
        title: 'Design Immersif',
        description:
          "Création d'une identité visuelle spatiale (noir profond, violet et bleu néon, étoiles). Design de la typographie pour une lecture confortable. Maquettes Figma avec animations et transitions cosmiques.",
      },
      {
        title: 'Architecture Technique',
        description:
          'Mise en place de Contentful comme CMS headless. Modélisation des contenus (articles, auteurs, catégories). Intégration GraphQL pour les requêtes optimisées. Système de cache et ISR (Incremental Static Regeneration).',
      },
      {
        title: 'Développement',
        description:
          'Développement Next.js avec génération statique des articles. Intégration du système de commentaires. Création des pages auteurs et catégories. Optimisation des images et performances.',
      },
      {
        title: 'Contenu & Lancement',
        description:
          'Rédaction de 20+ articles de lancement. Création de visuels cosmiques (illustrations, photos NASA). Optimisation SEO et balises meta. Déploiement avec monitoring et analytics.',
      },
    ],
    technologies: [
      'Next.js 14',
  ...
  // ========================================
  {
    ...
    shortDescription:
      'Site vitrine immersif pour un studio de motion design spécialisé dans les animations 3D et les expériences visuelles innovantes.',
    description:
      "Création d'un site vitrine spectaculaire pour KINETIC STUDIO, studio fictif de motion design et d'animation 3D. Le site met en avant le portfolio du studio avec des animations Three.js, des transitions fluides et une esthétique cyberpunk moderne.",
    context:
      "KINETIC STUDIO est un studio créatif spécialisé dans le motion design, l'animation 3D et les expériences visuelles immersives. Le studio travaille pour des marques premium, des startups tech et des agences de communication. Il avait besoin d'un site vitrine à la hauteur de son expertise technique et créative.",
    objectives: [
    ...
    target:
      "Marques premium, startups tech, agences de communication et entreprises recherchant des services de motion design et d'animation 3D haut de gamme.",
    deliverables: [
    ...
    process: [
      {
        ...
        description:
          "Définition de l'identité visuelle cyberpunk (noir, cyan, magenta, reflets métalliques). Création d'un moodboard avec références (Awwwards, Behance). Conception de l'univers 3D et des animations clés.",
      },
      {
        title: 'Prototypage 3D',
        description:
          'Création de prototypes Three.js pour la hero section. Tests de performances et optimisations. Conception des animations de transition entre pages. Validation de la faisabilité technique.',
      },
      {
        title: 'Design & Maquettage',
        description:
          'Maquettes Figma avec animations et transitions. Design des pages (accueil, portfolio, à propos, contact). Création de composants réutilisables. Prototypage des interactions.',
      },
      {
        title: 'Développement',
        description:
          'Développement Next.js avec intégration Three.js et Framer Motion. Optimisation des performances (lazy loading, code splitting, compression). Intégration des vidéos et animations. Tests multi-devices.',
      },
      {
        title: 'Contenu & Lancement',
        description:
          'Création de contenus (textes, vidéos, animations). Optimisation SEO et balises meta. Tests de performances (Lighthouse). Déploiement sur Vercel avec CDN et monitoring.',
      },
    ],
    technologies: [
      'Next.js 14',
